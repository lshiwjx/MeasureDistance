...
QT_MOC_LITERAL(1, 8, 11), // "setDistance"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 8), // "distance"
QT_MOC_LITERAL(4, 30, 15), // "requestDistance"
QT_MOC_LITERAL(5, 46, 5), // "angle"
QT_MOC_LITERAL(6, 52, 11) // "updateFrame"

    },
    "MyLabel\0setDistance\0\0distance\0"
    "requestDistance\0angle\0updateFrame"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setDistance((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 1: _t->requestDistance((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (MyLabel::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::setDistance)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::requestDistance)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyLabel::setDistance(float _t1)
{
...
// SIGNAL 1
void MyLabel::requestDistance(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
