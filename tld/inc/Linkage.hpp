...
This file was adapted from a MEX-file for MATLAB.
...
//linkageT(nlhs,plhs,nrhs,prhs,(nrhs==3), (double)(1.0));

template<class TEMPL>
void linkageT(const char* method)
...
/* GATEWAY FUNCTIONS */
void linkage(double bdd, const char* method)
{
	linkageT(method, nlhs,plhs,nrhs,prhs,(nrhs==3), (double)(1.0));
}

void linkage(float bdd, const char* method)
{
	linkageT(method, nlhs,plhs,nrhs,prhs,(nrhs==3), (float)(1.0));
}
